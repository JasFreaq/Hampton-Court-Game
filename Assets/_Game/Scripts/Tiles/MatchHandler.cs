...
public class MatchHandler : MonoBehaviour
{
    ...
    public bool HasMatches(Vector2Int index, out List<TileObject> matchingTiles)
    {
        HashSet<TileObject> horizontalTiles = new HashSet<TileObject> { m_board.BoardTileObjects[index.x, index.y] };
        ...
        HashSet<TileObject> verticalTiles = new HashSet<TileObject> { m_board.BoardTileObjects[index.x, index.y] };
    ...
    public HashSet<TileObject> CheckMatchesHorizontal(Vector2Int index, HashSet<TileObject> matchingTiles)
    {
        if (index.x > 0)
        {
    ...
    public HashSet<TileObject> CheckMatchesVertical(Vector2Int index, HashSet<TileObject> matchingTiles)
    {
        if (index.y > 0)
        {
